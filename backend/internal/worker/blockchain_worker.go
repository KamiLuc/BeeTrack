...
// RPC interaction for honey batch certification. Idempotency (HC-BE-25) is
// enforced in three layers: the contract's revert-on-duplicate, this
// package's pre-submit live-certification check, and a DB partial unique
// index — see TestProcessNextJob_MidBroadcastCrashRecovery.
package worker
