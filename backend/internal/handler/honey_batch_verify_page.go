...
var verifyPageEN = verifyPageStrings{
	...
	MetadataHashExplainer: "Checksum of the batch's gathering date, amount, processing method, honey type, and PDF checksum together.",
...
var verifyPagePL = verifyPageStrings{
	...
	MetadataHashExplainer: "Suma kontrolna daty pozyskania, ilości, metody przetwarzania, rodzaju miodu i sumy kontrolnej PDF-u razem.",
