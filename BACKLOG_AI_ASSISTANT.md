...
| ID        | Layer | Status | Title                                    | Notes                                                                                                          |
| --------- | ----- | ------ | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| AST-01-BE | `BE`  | `[ ]`  | `internal/mcp/` package + tool registry  | In-process, no separate deployment; tools call straight into existing repositories (§3.2)                       |
| AST-02-BE | `BE`  | `[ ]`  | Tool: `list_hives`                       | Optional `apiary_id` filter — also called directly by VC-08-BE for hive-name resolution (§3.3)                  |
| AST-03-BE | `BE`  | `[ ]`  | Tool: `get_hive_summary`                 | Latest inspection, active treatments, last harvest (§3.3)                                                       |
